sudo $VPP_ROOT/build-root/install-vpp-native/vpp/bin/vpp unix {nodaemon} cpu {main-core 28 corelist-workers 29,30} api-segment {prefix vpp1} dpdk { dev $LC1P0 {num-rx-queues 2 }  dev $LC1P1 {num-rx-queues 2}  socket-mem 4096,4096} plugin_path $VPP_ROOT/build-root/install-vpp-native/vpp/lib64/vpp_plugins
